...
*   Enemy hexagons are shrouded. You can see they are occupied, but you do not know the number of soldiers guarding them.
*   **Scouting:** Before you attack, you can deploy a Support unit (Scout) on-site to discover the number of defenders.
...
*   **Result:** The larger army wins. The defeated army is permanently destroyed. The winning army's remaining soldiers stay in the hexagon as the new garrison.